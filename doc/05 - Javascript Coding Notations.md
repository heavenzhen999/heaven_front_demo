# Javascript Coding Notations

> JavaScript 代码规范。遵循 JavaScript Standard Style 规范制定。并进行自定义的设定。

## 细则

* **使用let/const代替var**

  esling: [`no-var`](https://eslint.org/docs/rules/no-var#require-let-or-const-instead-of-var-no-var)
